...
const accessControlRoutes = require('./routes/accessControlRoutes'); // Импорт маршрутов для контроля доступа
...
app.use('/api/access-control', accessControlRoutes); // Подключение маршрутов для контроля доступа
